...
<script type="text/javascript">
	var photoId = "${param.photoId}";
	var callBackFuntion = "${param.callBack}";
	...
	$(function(){
		...
		$(".wyx-upload-btns .save").click(function(){
			if(photoId){
				$("#"+photoId,parent.document).attr("src",cropper.getCroppedImageData(200,200));
			}
			if(callBackFuntion){
				eval("window.parent."+callBackFuntion+"()");
			}
	...
	<div style="width:600px;height:525px;">
		<div class="ui-dialog-content" data-role="content" style="height: 100%; zoom: 1; background: rgb(255, 255, 255);"><div class="app-wyx-upload">
		    ...
		    <div class="wyx-upload-btns">
			    <button class="btn btn-success btn-sm rotate-btn" id="rotateLeftBtn">向左旋转</button>
			    <button class="btn btn-success btn-sm rotate-btn" id="rotateRightBtn">向右旋转</button>
